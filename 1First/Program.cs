...
//     else return $"{(Nature(N-1) + N)} "; // В противном случае печатаем N
...
// string Nature (int N) 
// {
//     if (N==1) return "1"; // Если N==1 выводим на печать 1
//     else return $"{N + " " + (Nature(N-1))}"; // В противном случае печатаем N, 
//     // и вызываем метод Nature(N-1). И так, пока не дойдем до 1.
//     // Запись $"{N + " " + (Nature(N-1))}"; значит - пиши число N, потом пробел,
//     // а потом N-1 и т.д.
// }
// Console.WriteLine(Nature(5));
...
//         // Вернуть m, пробел, рекурсия: число M на 1 меньше, и так до N
//     } 
//     else // m <= n
//     {
//         if (m == n) 
...
//         }
//         return $"{m + " " + Numbers(m + 1, n)}";
//         // Вернуть m, пробел, рекурсия: число M на 1 больше, и так до N
//     }
// }
// Console.WriteLine(Numbers(5,8));
...
//     if (n < 10) 
//     {
//         return n; // Одна цифра в числе, ее и возвращаем
//     }
//     else 
//     {
//         return n % 10 + SumOfDigits(n / 10);
//         // Вычисляем остаток от деления на 10 и прибавляем к нему
//         // наш метод, принявший уже n / 10 (число без последней цифры)
//         // и так, пока в числе не останется одна цифра
//         // ее прибавляем последней.
//     }
// }
// Console.WriteLine(SumOfDigits(2225));



// 71. Написать программу вычисления функции Аккермана
// uint Ackermann(uint m, uint n) // принимает неотрицательные целые числа и отдает натуральное
// {
//   if (m == 0)
//     return n + 1;
//   else
//     if ((m != 0) && (n == 0)) // Т.к. unit-> m!=0 == m>0 (по условию m>0)
//       return Ackermann(m - 1, 1);
//     else // Если m>0 & n>0
//       return Ackermann(m - 1, Ackermann(m, n - 1));
// } // Тут просто описание функции Аккермана. Как работает - не понял (сама функция).
//     // Но ясно, что с каждым шагом m и n уменьшаются, и когда m станет = 0
//     // n станет n+1
// Console.WriteLine(Ackermann(2,1));
...
// 74. В некотором машинном алфавите имеются четыре буквы «а», 
// «и», «с» и «в». Покажите все слова, состоящие из n букв, 
